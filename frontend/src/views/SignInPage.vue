...
// A function that is called when the user clicks the submit button. It sends a POST request to the
// server with the username and password. If the request is successful, it sets the userID and userName
// in the store and redirects the user to the home page. If the request is unsuccessful, it sets the
// wrong variable to true, which displays an error message.
