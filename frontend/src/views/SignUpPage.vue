...
// A function that is called when the user clicks the submit button. It is an async function because it
// is making an API call. It is setting the loading state to true, making the API call, and then
